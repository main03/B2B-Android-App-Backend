...
exports.CreateNewCategory=(AuthenticateAdmin,async (req,resp,next)=>
{
...
// category get api 
exports.GetallCategoryList=(AuthenticateAdmin,async(req,res,next)=>
{
...
exports.UpdateCategory=(AuthenticateAdmin,(req,res,next)=>
{
...
exports.DeleteCategory=(AuthenticateAdmin,async (req,res)=>
{
  try{
